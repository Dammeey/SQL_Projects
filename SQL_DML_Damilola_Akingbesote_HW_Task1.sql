...
FROM actor a, film f 
WHERE upper(a.first_name) IN ('ALVARO', 'URSULA')
AND upper(a.last_name) IN ('MORTE', 'CORBERO')
...
SELECT a.actor_id, f.film_id 
FROM actor a, film f 
WHERE upper(a.first_name) IN ('BOB', 'ANNIE')
AND upper(a.last_name) IN ('HARRIS', 'NIGHTINGALE')
...
SELECT a.actor_id, f.film_id 
FROM actor a, film f 
WHERE upper(a.first_name) IN ('JESSE', 'MORGAN')
AND upper(a.last_name) IN ('WILLIAMS', 'FREEMAN')
